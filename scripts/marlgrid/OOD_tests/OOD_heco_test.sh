...
ExpName="OOD_heco_test_"${env_name}"_"${N_agents}"_"${coordination}"_"${heterogeneity}"_"${policy}"-"${use_policy_pool}"-"${latent_kl}"_"${seed}
...
runner.params.checkpoint_dir="outputs/"${env_name}"_"${N_agents}"_"2"_"2"_"${policy}"-"${use_policy_pool}"-"${latent_kl}"_"${seed} \
