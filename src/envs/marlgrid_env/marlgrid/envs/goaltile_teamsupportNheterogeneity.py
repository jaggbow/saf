from ..base import MultiGridEnv_TeamSupportNheterogeneity, MultiGrid
from ..objects import *


class ClutteredGoalTileTeamsupportNHeterogneityEnv(MultiGridEnv_TeamSupportNheterogeneity):
