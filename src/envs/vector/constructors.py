"""
Adapted from:
https://github.com/Farama-Foundation/SuperSuit/blob/767823849865af32050fee5c6a7d2fa7d86c4973/supersuit/vector/constructors.py
"""
...
def MakeCPUAsyncConstructor(max_num_cpus):
    if max_num_cpus == 0 or max_num_cpus == 1:
        ...
        def constructor(env_fn_list, obs_space, state_space, act_space):
